...
$(document).ready(function(){
	...
	// if (p.length==1) {
		...
		// p.remove();
	// }
	$('#footer_info').html('ООО «Ипотечный центр недвижимости» занимается консультационной<br/>деятельностью по подбору ипотечных программ, не является<br/>кредитной организацией и самостоятельно не выдает ипотеку.');
	$('#loading').fadeOut(160);
});
